...
interface HeaderProps {
  currentPage?: 'home' | 'about' | 'privacy' | 'terms' | 'contact' | 'advanced-tools';
          ...
          >
            <div className="relative">
              <div className="bg-gradient-to-br from-violet-600 via-purple-600 to-blue-600 p-2 sm:p-3 rounded-xl sm:rounded-2xl shadow-lg">
                <Image className="h-5 w-5 sm:h-7 sm:w-7 text-white" />
            ...
            <div>
              <h1 className="text-lg sm:text-2xl font-bold bg-gradient-to-r from-violet-600 to-blue-600 bg-clip-text text-transparent">
                JPG2GO
              </h1>
              <p className="text-xs text-gray-500 font-medium hidden sm:block">AI-Powered Image Converter</p>
            </div>
          </button>
