...
import { 
  FileText, Scale, AlertTriangle, CheckCircle, Users,
  Shield, Zap, Globe, Clock, ArrowLeft, Sparkles
} from 'lucide-react';
...
const TermsOfService: React.FC<TermsOfServiceProps> = ({ onBack }) => {
  const sections = [
    ...
    },
    {
      ...
      content: [
        "JPG2GO is a free, web-based image conversion and optimization tool that processes images locally in your browser.",
        "The service allows users to convert between various image formats, apply filters, resize images, and optimize file sizes.",
